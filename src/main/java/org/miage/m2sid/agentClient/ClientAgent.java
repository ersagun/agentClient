...
public class ClientAgent extends Agent {
    ...
    public void demandeProduit(HashMap<Integer,Integer> listeDeCourses ) {
        addBehaviour(new TrouverSupermarcheBehaviour(this, listeDeCourses));
    }
     ...
     */
    /**
     * private class RechercherBehaviour extends Behaviour { private AID
     * supermarcheChoisi; // The agent who provides the best offer private
     * MessageTemplate mt; // The template to receive replies private int step =
     * 0;
     *
     * public void action() { switch (step) { case 0: System.out.println("Case
     * 0");
     *
     ...
     * }
     *
     * if (repliesCnt >= sellerAgents.length) { // We received all replies step
     * = 2; } repliesCnt++; } else { block(); } break; } }
     *
     * public boolean done() { if (step == 2 && supermarcheChoisi == null) { }
